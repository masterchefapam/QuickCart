...
const Navbar = () => {
  ...
  return (
    <nav className="flex items-center justify-between px-6 md:px-16
     lg:px-32 py-3 border-b border-gray-300 text-gray-700">
      <Image
      ...
      <ul className="hidden md:flex items-center gap-4 ">
        ...
        
        {
          ...
          ? <>
             ...
             <UserButton.MenuItems>
                 <UserButton.Action label="All Products" labelIcon={<BoxIcon/>} onClick={()=>(router.push('/all-products'))}></UserButton.Action> 
             </UserButton.MenuItems>
             <UserButton.MenuItems>
